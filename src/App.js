...
function Cursor() {
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      if (dot.current)
        dot.current.style.transform = `translate(${rpos.current.x - 10}px,${rpos.current.y - 10}px)`;
...
function LyricsModal({ track, onClose }) {
  ...
  const startFlow = useCallback(() => {
    ...
    tRef.current = setInterval(() => {
      ...
      setRevealed(
        (p) => p + (iRef.current > 0 ? " " : "") + words[iRef.current++],
      );
    }, 160);
  }, [words]);
    ...
    <Modal onClose={onClose}>
      <div style={{ padding: "0 2.5rem 3rem" }}>
        <div style={{ paddingTop: "0.5rem", marginBottom: "2rem" }}>
          ...
          {track.key && (
            <div
              style={{ fontSize: 11, color: T.faint, letterSpacing: "0.1em" }}
            >
              {track.key} · {track.dur}
            </div>
          )}
        ...
        >
          <span style={{ fontSize: 9, letterSpacing: "0.3em", color: T.faint }}>
            LYRICS
          </span>
          <button
        ...
        {album.tracks?.map((t, i) => (
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              {t.highlight && (
                <div
                  style={{ fontSize: 11, color: T.faint, fontStyle: "italic" }}
                >
                  "{t.highlight}"
                </div>
              )}
        ...
        {links.map((l) => (
          <button
            ...
            style={{
              ...
              transition: "color .15s",
              borderBottom:
                page === l.id ? `1px solid ${T.ink}` : "1px solid transparent",
              paddingBottom: 2,
            }}
          >
            {l.label}
...
function HomePage({ onNav }) {
  ...
  useEffect(() => {
    const id = setInterval(
      () => setLyricIdx((i) => (i + 1) % snippets.length),
      3800,
    );
    ...
    >
      ...
      >
        ...
        >
          Making
          <br />
          <em style={{ fontWeight: 300 }}>music</em>
          <br />
        ...
        <div
          className="s3"
          style={{ marginBottom: "4rem", overflow: "hidden", height: 52 }}
        >
          <div key={lyricIdx} style={{ animation: "fadeUp .5s ease both" }}>
            ...
            <div
              style={{ fontSize: 10, letterSpacing: "0.2em", color: T.faint }}
            >
...
function LyricsPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", paddingTop: 64 }} className="page-in">
      <div
        style={{ padding: "4rem 3rem 3rem", maxWidth: 960, margin: "0 auto" }}
      >
        <div
          style={{
            fontSize: 10,
      ...
      >
        <div>
          ...
          >
            {hov ? (
              <span
                style={{ animation: "fadeUp .25s ease both", display: "block" }}
              >
                "{r.highlight}"
              </span>
            ) : (
        ...
        >
          ...
          <span style={{ fontSize: 11, color: T.faint }}>
            {r.trackCount ? `${r.trackCount} tracks` : r.dur}
          </span>
          <span
            style={{
              fontSize: 9,
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "4rem 3rem" }}>
        ...
        >
          <div>
            ...
            >
              "Music and code are two sides of the same creative coin — both
            ...
            >
              I'm Pulkit J — a bilingual artist and developer at the
              intersection of tradition and innovation. Growing up between
              cultures, I found myself drawn to blending South Asian musical
              traditions with contemporary pop and R&B production.
            </p>
            <p
              style={{
                color: T.inkL,
            ...
            >
              Hindi and English became more than languages — they became tools
              for emotional storytelling. As a developer, I see music production
              through a unique lens: every beat an algorithm, every melody a
              function, every song a carefully architected experience.
            </p>
            <p style={{ color: T.inkL, lineHeight: 1.9, fontSize: 14 }}>
              My goal isn't just to make songs, but to build experiences —
              soundscapes where tradition meets innovation, where every element
              serves the story I'm trying to tell.
            </p>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              {[
                {
                  n: "Songwriting",
                  d: "Bilingual lyricism with emotional precision",
                },
                {
                  n: "Vocals",
                  d: "Expressive across Pop, R&B & Hindustani traditions",
                },
                {
                  n: "Production",
                  d: "Layered textures, cinematic sound design",
                },
                ...
                >
                  <div style={{ fontSize: 12, color: T.inkL, marginBottom: 3 }}>
                    {s.n}
                  </div>
                  <div
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "4rem 3rem" }}>
        ...
        >
          <div>
            ...
            >
              Interested in collaborations, live sessions, or just want to talk
              music and code? The studio is always open.
            </p>
            ...
            {[
              {
                label: "Email",
                val: "contact@pulkitj.com",
                href: "mailto:contact@pulkitj.com",
              },
              {
                label: "Instagram",
                val: "@pulkitj",
